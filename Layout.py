...
def scoreIncrement(playerShow,pcShow):

	if playerShow==pcShow:
		return 0

	if playerShow == "rock" and pcShow == "paper":
		return -1
	elif playerShow == "paper" and pcShow == "scissor":
		return -1
	elif playerShow == "scissor" and pcShow == "rock":
		return -1
	else:
		return 1
...
def Credits():
	...
	while click == "True":
		...
		click = button("Main",display_width*0.2,display_height*0.75,100,50,yellow,light_yellow,"game_intro",click)
		click = button("Quit",display_width*0.45,display_height*0.75,100,50,yellow,light_yellow,"quit",click)
